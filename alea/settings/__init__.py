"""
Django default settings for alea project.
...
SECRET_KEY = "cqx4s9%gp*vk9au8+w^#0n!^=$w2jd6giyt5b8p37zde@5ms^p"
...
EMAIL_USE_TLS = True
pipEMAIL_HOST = os.getenv("MAIL_HOST")
...
WSGI_APPLICATION = "alea.wsgi.application"
